...
@Component({
  selector: 'app-activationrecords',
  templateUrl: './activationrecords.component.html',
  styleUrls: ['./activationrecords.component.scss']
})
export class ActivationrecordsComponent implements OnInit {
